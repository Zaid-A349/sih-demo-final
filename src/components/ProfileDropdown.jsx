...
export const ProfileDropdown = ({ user, userType, getUserTypeColor, getInitials, onLogout }) => {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex items-center space-x-3 hover:bg-accent/10 rounded-lg p-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/20">
      ...
      <DropdownMenuContent className="w-64 p-2" align="end" sideOffset={5}>
        ...
        <DropdownMenuItem 
          className="flex items-center space-x-2 p-2 cursor-pointer text-destructive focus:text-destructive"
          onClick={onLogout}
        >
