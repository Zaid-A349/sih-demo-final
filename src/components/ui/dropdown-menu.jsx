...
const DropdownMenuSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
  React.createElement(DropdownMenuPrimitive.SubTrigger, {
    ...
    children: [
      children,
      React.createElement(ChevronRight, { key: "chevron", className: "ml-auto h-4 w-4" })
    ]
  })
));
...
const DropdownMenuContent = React.forwardRef(({ className, sideOffset = 4, ...props }, ref) => (
  React.createElement(DropdownMenuPrimitive.Portal, {
    children: React.createElement(DropdownMenuPrimitive.Content, {
      ref,
      sideOffset,
      className: cn(
  ...
  React.createElement(DropdownMenuPrimitive.CheckboxItem, {
    ...
    children: [
      React.createElement("span", {
        ...
        children: React.createElement(DropdownMenuPrimitive.ItemIndicator, {
          children: React.createElement(Check, { className: "h-4 w-4" })
        })
      }),
      children
    ]
  ...
  React.createElement(DropdownMenuPrimitive.RadioItem, {
    ...
    children: [
      React.createElement("span", {
        ...
        className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center",
        children: React.createElement(DropdownMenuPrimitive.ItemIndicator, {
          children: React.createElement(Circle, { className: "h-2 w-2 fill-current" })
        })
      }),
      children
    ]
